...
<table width="96%" height="512" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3"
    ...
    <c:forEach items="${staffinformationList}" var="staffinformation">
        ...
        <tr>
            ...
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6"
                                         value="${staffinformation.cellphone}" size="30" class="pi"></td>
            <td align="right" bgcolor="#FFFFFF">电话：</td>
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6" value="${staffinformation.phone}"
                                         size="30" class="pi"></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FFFFFF">工种：</td>
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6" value="${staffinformation.type}"
                                         size="30" class="pi"></td>

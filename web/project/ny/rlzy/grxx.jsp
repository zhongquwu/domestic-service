            ...
            <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
                <tr>
                    ...
                    <td nowrap width="55%" align="right"><input type="hidden" name="currentPage" value="1">
                        <a href="staffsvl?pageNow=1&reqType=querystaff&searchName=${staff.wname}&radio=${staff.wsex}&searchName2=${staff.wage}&select=${staff.status}&select2=${staff.grskills}&searchbtn2=查询">首页</a>
                        <a href="staffsvl?pageNow=${pageNow-1}&reqType=querystaff&searchName=${staff.wname}&radio=${staff.wsex}&searchName2=${staff.wage}&select=${staff.status}&select2=${staff.grskills}&searchbtn2=查询">上一页</a>
                        <a href="staffsvl?pageNow=${pageNow+1}&reqType=querystaff&searchName=${staff.wname}&radio=${staff.wsex}&searchName2=${staff.wage}&select=${staff.status}&select2=${staff.grskills}&searchbtn2=查询">下一页</a>
                        <a href="staffsvl?pageNow=${totalpage}&reqType=querystaff&searchName=${staff.wname}&radio=${staff.wsex}&searchName2=${staff.wage}&select=${staff.status}&select2=${staff.grskills}&searchbtn2=查询">尾页</a>
                        <a href="#" onclick="selectJump()">前往</a>
                        <input type=text size='4' onlytype='int' onfocus='checkTextBoxInput()' id="jumppage2"
...
<script>
    ...
    function selectJump() {
        var jumppage2 = document.getElementById("jumppage2").value;
        window.location.href = "staffsvl?pageNow=" + jumppage2 + "&reqType=querystaff&searchName=${staff.wname}&radio=${staff.wsex}&searchName2=${staff.wage}&select=${staff.status}&select2=${staff.grskills}";
    }
